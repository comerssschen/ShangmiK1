...
import com.sunmi.sunmit2demo.openapi.AlipayCallBack;
import com.sunmi.sunmit2demo.openapi.AlipayClient;
import com.sunmi.sunmit2demo.openapi.AlipayResponse;
import com.sunmi.sunmit2demo.openapi.DefaultAlipayClient;
import com.sunmi.sunmit2demo.openapi.ZimIdRequester;
import com.sunmi.sunmit2demo.openapi.request.AlipayTradePayRequest;
import com.sunmi.sunmit2demo.openapi.response.AlipayTradePayResponse;
...
public class AlipaySmileModel {
    ...
    public void setGoods(List<MenusBean> list) {
        this.menus = list;
    }
    ...
    public void startChargeback(final String out_trade_no, final String fToken, final String amount, final String subject, final String store_id, final AlipayModelCallBack alipayModelCallBack) {
        ...
        String json = JSON.toJSONString(buildAlipayRequest(out_trade_no, fToken, amount, subject, store_id));
        Log.e("@@@@@", json);
    ...
    private BizContentBean buildAlipayRequest(String out_trade_no, String fToken, String money, String subject, String store_id) {
        ...
        bizContentBean.setBody("每日付智慧收银演示");
        ...
        for (MenusBean listBean : menus) {
            ...
            goodsDetailBean.setBody(listBean.getUnit());
            goodsDetailBean.setGoods_id(listBean.getId());
            goodsDetailBean.setGoods_name(listBean.getName());
            goodsDetailBean.setPrice(listBean.getMoney().substring(1));
